...
;(async () => {
	...
	const sampleFiles = [ path.join(__dirname, '../samples/big_buck_bunny.mp4') ]
	const qualities = [ null, 100, 92, 75, 50, 25 ]
	//const outputFileExtensions = [ 'jpg', 'png', 'svg' ]
	const outputFileExtensions = [ 'jpg' ]
	const dimensions = [
